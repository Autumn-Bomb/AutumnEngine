...
AutumnEngine::Spritesheet::Spritesheet() { m_Texture = nullptr; }
AutumnEngine::Spritesheet::Spritesheet(sf::Texture* texture)
{
...
AutumnEngine::Spritesheet::~Spritesheet() { }

void AutumnEngine::Spritesheet::LoadSprite(std::string filePath)
{
	if (!m_Texture->loadFromFile(filePath))
		std::cout << "File not found: " << filePath << std::endl;
}

void AutumnEngine::Spritesheet::AddSprite(sf::IntRect spritePosSize, sf::Vector2f position)
{
...
void AutumnEngine::Spritesheet::Batch()
{
...
void AutumnEngine::Spritesheet::Render(sf::RenderWindow* window)
{
